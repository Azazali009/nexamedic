      ...
      {product?.specs && (
        <div className={`space-y-12 px-8 py-10 sm:px-14 sm:py-20`}>
          ...
          {active === "specs" && (
            ...
            >
              <div className="prose prose-ul:flex prose-ul:flex-col prose-p:m-0 prose-a:text-inherit prose-li:text-wrap xs:text-xl flex max-w-none flex-col gap-0 text-sm text-inherit">
                <Markdown
                  components={{
                    a: ({ node, ...props }) => (
