      ...
      <ul className="list-item list-decimal space-y-8">
        <li>
          ...
          <div className="space-y-4">
            <p>Nexamedic SA Bernstrasse 18 2555 Brügg, Switzerland </p>
            <p>📞 Phone: +41 (0)32 552 7070</p>
            <p>✉️ Email: info@nexamedic.ch</p>
            <p>🌐 Website: www.nexamedic.ch UID: CHE-292.506.716</p>
          </div>
        </li>
        <li>
